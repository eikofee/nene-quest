...
ConfigParser::ConfigParser() { configFilesPath = "config"; }
...
void ConfigParser::initialize() {
    ...
    paramsIntType = {"fullscreen", "resolution"};
    ...
    configKeyboardNames = {
        ...
        "I",      "J",     "K",    "L",    "M",    "N",     "O",     "P",
        "Q",      "R",     "S",    "T",    "U",    "V",     "W",     "X",
        "Y",      "Z",     "UP",   "DOWN", "LEFT", "RIGHT", "SPACE", "RETURN",
        "LSHIFT", "LCTRL", "LALT", "NP0",  "NP1",  "NP2",   "NP3",   "NP4",
        "NP5",    "NP6",   "NP7",  "NP8",  "NP9",
    };
    ...
    configKeyboardEquiv = {
        ...
        sf::Keyboard::G,       sf::Keyboard::H,        sf::Keyboard::I,
        sf::Keyboard::J,       sf::Keyboard::K,        sf::Keyboard::L,
        sf::Keyboard::M,       sf::Keyboard::N,        sf::Keyboard::O,
        sf::Keyboard::P,       sf::Keyboard::Q,        sf::Keyboard::R,
        sf::Keyboard::S,       sf::Keyboard::T,        sf::Keyboard::U,
        sf::Keyboard::V,       sf::Keyboard::W,        sf::Keyboard::X,
        sf::Keyboard::Y,       sf::Keyboard::Z,        sf::Keyboard::Up,
        sf::Keyboard::Down,    sf::Keyboard::Left,     sf::Keyboard::Right,
        sf::Keyboard::Space,   sf::Keyboard::Return,   sf::Keyboard::LShift,
        sf::Keyboard::LAlt,    sf::Keyboard::LControl, sf::Keyboard::Numpad0,
    ...
    if (file.is_open()) {
        while (std::getline(file, line)) {
            if (line.length() > 1 && line.at(0) != ';') {
                ...
                std::string v =
                    line.substr(line.find(ds) + 1, line.length() - 1);
...
sf::Keyboard::Key ConfigParser::parseKey(std::string str) {
    for (decltype(configKeyboardNames)::size_type i = 0;
        ...
        if (str == configKeyboardNames[i]) return configKeyboardEquiv[i];
...
bool ConfigParser::isIn(std::string value, std::vector<std::string> vec) {
    for (auto v : vec) {
        if (!value.compare(v)) return true;
    }
